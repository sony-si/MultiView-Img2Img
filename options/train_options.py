...
class TrainOptions(BaseOptions):
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--shared_loss_weight', type=int, default=0.1, help='multiply shared loss')

        parser.add_argument('--MSE_3DPose_threshold', type=int, default=40, help='')
